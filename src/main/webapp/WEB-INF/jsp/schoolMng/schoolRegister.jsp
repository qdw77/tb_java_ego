	...
	<input type="hidden" id="schoolId" name="schoolId" value="${schoolInfo.schoolId }"/>
		...
		<table style="border: 1px solid #444444;">
			<tr>
				...
				<td style="border: 1px solid #444444; width: 200px;"><input
					type="text" id="schoolName" name="schoolName"
					value="${schoolInfo.schoolName }" /></td>

			</tr>
			<tr>
				<th style="border: 1px solid #444444;">지역구</th>
				<td style="border: 1px solid #444444; width: 200px;"><input
					type="text" id="schoolArea" name="schoolArea"
					value="${schoolInfo.schoolArea }" /></td>
			</tr>
			<tr>
				<th style="border: 1px solid #444444;">학교 주소</th>
				<td style="border: 1px solid #444444; width: 200px;"><input
					type="text" id="schoolAddr" name="schoolAddr"
					value="${schoolInfo.schoolAddr }" /></td>
			</tr>
			<tr>
				<th style="border: 1px solid #444444;">학교 연락처</th>
				<td style="border: 1px solid #444444; width: 200px;"><input
					type="text" id="schoolPhone" name="schoolPhone"
					value="${schoolInfo.schoolPhone }" /></td>
			</tr>
